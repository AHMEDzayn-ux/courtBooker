          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 divide-y lg:divide-y-0 lg:divide-x divide-gray-100">
            ...
            <div className="p-4 flex items-center justify-between">
              <div>
                ...
                <p className="text-lg font-bold text-gray-900 mt-0.5">{stats.todayBookings} <span className="text-xs font-normal text-gray-400">Bookings</span></p>
              </div>
            ...
            <div className="p-4 flex items-center justify-between">
              <div>
                ...
                <p className="text-lg font-bold text-gray-900 mt-0.5">{stats.totalBookings}</p>
              </div>
            ...
            <div className="p-4 flex items-center justify-between">
              <div>
                ...
                <p className="text-lg font-bold text-gray-900 mt-0.5">{stats.totalCourts}</p>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
          ...
          <div className="lg:col-span-2 bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div className="px-5 py-3 border-b border-gray-200 flex justify-between items-center bg-gray-50/50">
              <h2 className="text-xs font-bold text-gray-500 uppercase tracking-wide">Recent Activity</h2>
                    ...
                    recentBookings.map((booking) => (
                      <tr key={booking.id} className="hover:bg-gray-50/80 transition-colors group">
                        ...
                        <td className="px-5 py-3 text-gray-900 text-xs font-medium">
                          {booking.courts.name}
                          <span className="text-[10px] text-gray-400 block">{booking.sports?.name}</span>
                        </td>
                        ...
                        <td className="px-5 py-3 text-right text-xs font-medium text-gray-900">
                          {parseFloat(booking.total_price || 0).toLocaleString('en-US', { minimumFractionDigits: 2 })}
                        </td>
                      </tr>
                    ))
                  )}
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <div>
                  <p className="text-sm font-semibold text-gray-900">Manage Availability</p>
                  <p className="text-[10px] text-gray-500">Block or unblock slots</p>
                </div>
              </Link>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-[10px] text-gray-500">Institution profile</p>
                </div>
              </Link>
