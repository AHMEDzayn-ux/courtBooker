...
export default function SettingsPage() {
  ...
  useEffect(() => {
    ...
    // Load PWA start page preference
    if (typeof window !== "undefined") {
      const savedStartPage = localStorage.getItem("pwaStartPage") || "/";
      setStartPage(savedStartPage);

      // Listen for changes
      const handleStorageChange = () => {
        const newStartPage = localStorage.getItem("pwaStartPage") || "/";
    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="p-6 sm:p-8 space-y-6">
            <h2 className="text-lg font-semibold text-gray-900 flex items-center gap-2">
              <span className="w-8 h-8 rounded-full bg-purple-50 text-purple-600 flex items-center justify-center text-sm">
                4
              </span>
              App Settings
            </h2>
            ...
            <div className="pl-0 md:pl-10 space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <h3 className="text-sm font-semibold text-blue-900 mb-1">
                      PWA Start Page Preference
                    </h3>
                    <p className="text-xs text-blue-800">
                      Choose where the app opens when launched from your home
                      screen. This setting is saved locally on your device.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  ...
                  >
                    <input
                      ...
                      checked={startPage === "/"}
                      onChange={(e) => {
                        localStorage.setItem("pwaStartPage", e.target.value);
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-xs text-gray-600 mt-0.5">
                        Browse and book courts (for customers)
                      </div>
                    </div>
                  </label>
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-xs text-gray-600 mt-0.5">
                        Quick access to manage your facility
                      </div>
                    </div>
                  </label>
                  ...
                  >
                    <input
                      type="radio"
                      name="startPage"
                      value="/institution/login"
                      checked={startPage === "/institution/login"}
                      onChange={(e) => {
                        localStorage.setItem("pwaStartPage", e.target.value);
                        setStartPage(e.target.value);
                      }}
                ...
                <div className="text-xs text-gray-500 bg-gray-50 border border-gray-200 rounded-lg p-3 mt-3">
                  <strong>Note:</strong> Changes take effect the next time you
                  open the app from your home screen. Current session is not
                  affected.
                </div>
              </div>
            </div>
