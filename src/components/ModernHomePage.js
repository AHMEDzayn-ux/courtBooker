...
import { Search, CalendarCheck, Zap, MapPin, Clock, Users, ArrowRight } from 'lucide-react'
...
const steps = [
  {
    ...
    description: 'Browse through our extensive list of indoor sports facilities across Sri Lanka'
  },
  {
    icon: CalendarCheck,
    title: 'Choose Time Slot',
    description: 'Select your preferred date and time with our interactive slot booking system'
  },
  {
    icon: Zap,
    title: 'Book Instantly',
    description: 'Confirm your booking in seconds and receive instant confirmation'
  }
]
...
export default function ModernHomePage() {
  ...
  const fetchData = async () => {
    ...
    const uniqueDistricts = [...new Set(institutionsData?.map(d => d.district) || [])]
  ...
  return (
    <div className="min-h-screen bg-white">
            ...
            >
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-base sm:text-lg font-medium">{allInstitutions.length}+ Venues</span>
                </div>
                <div className="flex items-center gap-2">
                  <Clock className="w-6 h-6" />
                  <span className="text-base sm:text-lg font-medium">24/7 Booking</span>
                </div>
                <div className="flex items-center gap-2">
                  <Zap className="w-6 h-6" />
                  <span className="text-base sm:text-lg font-medium">Instant Confirmation</span>
                </div>
              </motion.div>
        ...
        <div className="px-4 sm:px-6 lg:px-12 xl:px-20">
          ...
          >
            <div className="text-center mb-6">
              <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">Find Your Perfect Court</h3>
              <p className="text-sm text-gray-600">Search by name, location, or sport type</p>
            </div>
              ...
              <div className="flex items-center justify-between gap-4 pt-4 border-t border-gray-200">
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-gray-700 font-medium">
                    Found <span className="text-2xl font-bold text-indigo-600 mx-1">{institutions.length}</span> {institutions.length === 1 ? 'facility' : 'facilities'}
                  </p>
                </div>
      ...
      <section id="facilities" className="py-7 bg-gradient-to-b from-gray-50 to-white">
        <div className="px-4 sm:px-6 lg:px-12 xl:px-20">
          <div className="max-w-7xl mx-auto">
          {(searchQuery || selectedDistrict || selectedSport) && (
            <motion.div
          ...
          {loading ? (
            ...
            >
              <Swiper
                ...
                className="pb-12"
              >
                {institutions.map((facility) => (
                  <SwiperSlide key={facility.id}>
                    <Link href={`/institution/${facility.id}`}>
                      <motion.div
                        className="bg-gradient-to-br from-white to-gray-50 rounded-2xl border border-gray-200 shadow-lg overflow-hidden group cursor-pointer h-full transition-transform hover:-translate-y-1 hover:shadow-2xl"
                        whileHover={{ y: -10, scale: 1.02 }}
                        transition={{ duration: 0.3 }}
                      >
                        <div className="relative h-64 overflow-hidden">
                          <Image
                            src={facility.images?.[0] || 'https://images.unsplash.com/photo-1546519638-68e109498ffc?w=800'}
                            alt={facility.name}
                            fill
                        ...
                        <div className="p-6">
                          <p className="text-gray-600 mb-4 line-clamp-2">{facility.address}</p>
                          <div className="flex items-center justify-between">
                            <span className="text-sm text-gray-500">{facility.contact_number}</span>
        ...
        <div className="px-4 sm:px-6 lg:px-12 xl:px-20 py-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-6">
            ...
            <div className="col-span-2 md:col-span-1">
              <h3 className="text-white text-base font-bold mb-3">CourtBooker</h3>
              <p className="text-xs leading-relaxed">
                Your one-stop platform for booking indoor sports courts across Sri Lanka.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-1.5 text-xs">
                ...
                <li>
                  <Link href="/track-booking" className="hover:text-white transition-colors">
                    Track Booking
                  </Link>
                </li>
                <li>
                  <Link href="/institution/register" className="hover:text-white transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-1.5 text-xs">
                ...
                <li>
                  <a href="mailto:contact@courtbooker.lk" className="hover:text-white transition-colors flex items-center gap-2">
            ...
            {/* Developer Credit */}
            <div>
              <h3 className="text-white text-base font-bold mb-3">Developer</h3>
              <p className="text-xs">
                <span className="text-white font-semibold">Ruzayn Ahmedh</span>
              </p>
            </div>
          </div>
