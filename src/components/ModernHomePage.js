                        ...
                        <div className="p-4">
                              ...
                              {(() => {
                                ...
                                facility.courts?.forEach((court) => {
                                  court.court_sports?.forEach((cs) => {
                                    if (cs.sports?.name)
                                      uniqueSports.add(cs.sports.name);
                                  });
                                });
                                const sportsArray = Array.from(uniqueSports);
                                return sportsArray.length > 0 ? (
                                  sportsArray.slice(0, 4).map((sport) => (
                                    <span
                                      key={sport}
                                      className="px-1.5 py-0.5 bg-neutral-100 text-neutral-800 text-xs font-medium rounded"
                                    >
                                      {sport}
                                    </span>
                                  ))
                          ...
                          <div className="space-y-1.5 mb-3">
                            <div className="flex items-start gap-1.5">
                              <svg
                                className="w-3.5 h-3.5 text-neutral-700 mt-0.5 flex-shrink-0"
                                fill="none"
                                stroke="currentColor"
                                viewBox="0 0 24 24"
                              >
                            ...
                            <div className="flex items-center gap-1.5">
                              <svg
                                className="w-3.5 h-3.5 text-neutral-700 flex-shrink-0"
                                fill="none"
                                stroke="currentColor"
                                viewBox="0 0 24 24"
                              >
                          ...
                          <div className="pt-2.5 border-t border-gray-200">
                            <span className="text-sm text-slate-800 font-semibold flex items-center justify-center gap-1 group-hover:text-slate-900 transition-colors">
                              View & Book
